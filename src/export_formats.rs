...
/// Process Input via Weasyprint to generate a PDF
/// This ExportStep variant is used to process input using Weasyprint
#[derive(Debug, Serialize, Deserialize, Encode, Decode, Clone)]
pub struct WeasyprintExportStep {
    /// HTML input file, typically generated by a [RawExportStep]
    pub input_file: String,
    /// Path to output of PDF (e.g. book.pdf)
    pub output_file: String,
